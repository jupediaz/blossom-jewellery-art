...
export default async function CollectionsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="font-heading text-4xl font-light mb-2">Collections</h1>
      <p className="text-warm-gray mb-8">
        Each collection tells a different story — from Ukrainian heritage to Mediterranean gardens.
      </p>
